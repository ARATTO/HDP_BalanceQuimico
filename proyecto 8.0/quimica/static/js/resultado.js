...
function pieChart(cuadro, datos, efecto1) {
  ...
  var pullOutValueFont = "bold 8px 'Trebuchet MS', Verdana, sans-serif";  // Pull-out slice value font
  ...
  function init() {
    ...
    drawChart();
    $(efecto1).click ( handleChartClick );
  }
  ...
  function startPullOut ( slice ) {
    ...
    datos.removeClass('highlight');
    var labelCell = datos(':eq(' + (slice*2) + ')');
    var valueCell = datos(':eq(' + (slice*2+1) + ')');
